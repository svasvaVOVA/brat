(() => {
    ...
    (() => {
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".main-slider_positive-slider")) new core(".main-slider_positive-slider", {
                ...
                pagination: {
                    el: ".main-slider_positive__controll",
                    clickable: true
                },
                breakpoints: {
                    320: {
                ...
                on: {
                    init: function() {
                        const controll = document.querySelectorAll(".main-slider_positive__controll .swiper-pagination-bullet");
                    ...
                    breakpoint: function(swiper, info) {
                        !info.autoHeight ? document.querySelector(".main-slider_positive__swiper").style.height = "auto" : "";
                        swiper.updateSize();
                    }
                }
            });
...
***************************************************************************** */
        ...
        function documentAction(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                let subMenuId = targetElement.dataset.parent ? targetElement.dataset.parent : null;
                let subMenu = document.querySelector(`[data-submenu="${subMenuId}"]`);
                if (subMenu) {
                    targetElement.classList.toggle("_catalog-header-activ");
                    subMenu.classList.toggle("_catalog-header-open");
                } else console.log(" OOOO  OOO  O  SLOVA");
                e.preventDefault();
            }
        }
        document.documentElement.addEventListener("click", (function(e) {
            if (!e.target.closest(".auth-header__link")) {
                let subMenu = document.querySelector(`.catalog-header`);
                subMenu.classList.remove("_catalog-header-open");
            }
        }));
        window["FLS"] = true;
        isWebp();
